    ...
    @torch._inductor.config.patch(
        {
            **get_bucket_patches(),
            "aten_distributed_optimizations.enable_overlap_scheduling": True,
            "aten_distributed_optimizations.verify_spmd_graph": True,
            "aten_distributed_optimizations.spmd_verify_crash_on_mismatch": True,
        }
    )
    def test_spmd_verify_crashes_on_mismatch(self):
        """Test that spmd_verify_crash_on_mismatch raises on non-SPMD graphs."""
        ...
        with _dynamo_dist_per_rank_init(
            ...
            # With spmd_verify_crash_on_mismatch=True, this should raise.
