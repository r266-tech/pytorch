...
def _split_tensor(
    ...
    if _is_dtensor:
        ...
        split_fn = local_map(
            ...
            out_placements=tuple(placements for _ in range(num_chunks)),
    ...
    if _is_dtensor:
        ...
        expand_fn = local_map(
            _expand_chunks,
            out_placements=tuple(placements for _ in range(n)),
            in_placements=(placements,) + tuple(placements for _ in range(n)),
        )
