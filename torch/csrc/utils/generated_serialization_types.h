...
// checksum<<a841dcbc84339527507ad34834fa84ac5048f7ad2fe447fd540d992636bc8b89>>
// clang-format off
...
inline std::string_view printEnum(const ScalarType& e) {
  switch (e) {
    ...
    case ScalarType::FLOAT8E8M0FNU: return "FLOAT8E8M0FNU";
    default:
      throw std::runtime_error("Unknown enum value");
  }
}
...
inline void parseEnum(std::string_view s, ScalarType& t) {
  ...
  if (s == "FLOAT8E8M0FNU") { t = ScalarType::FLOAT8E8M0FNU; return; }
  throw std::runtime_error("Unknown enum value: " + std::string{s});
}
...
class Argument {
 ...
 public:
  ...
  const std::vector<std::vector<TensorArgument>>& get_as_nested_tensors() const {
  ...
  const std::vector<std::vector<int64_t>>& get_as_int_lists() const {
  ...
  const std::unordered_map<std::string, ForwardRef<Argument>>& get_as_string_to_argument() const {
  ...
  const std::vector<std::vector<F64>>& get_as_float_lists() const {
  ...
  friend void to_json(nlohmann::json& nlohmann_json_j, const Argument& nlohmann_json_t) {
    ...
    if (nlohmann_json_t.tag_ == Tag::AS_NESTED_TENSORS) {
      nlohmann_json_j["as_nested_tensors"] = nlohmann_json_t.get_as_nested_tensors();
      return;
    }
    if (nlohmann_json_t.tag_ == Tag::AS_INT_LISTS) {
      nlohmann_json_j["as_int_lists"] = nlohmann_json_t.get_as_int_lists();
      return;
    }
    if (nlohmann_json_t.tag_ == Tag::AS_STRING_TO_ARGUMENT) {
      nlohmann_json_j["as_string_to_argument"] = nlohmann_json_t.get_as_string_to_argument();
      return;
    }
    if (nlohmann_json_t.tag_ == Tag::AS_FLOAT_LISTS) {
      nlohmann_json_j["as_float_lists"] = nlohmann_json_t.get_as_float_lists();
      return;
    }
  }
  ...
  friend void from_json(const nlohmann::json& nlohmann_json_j, Argument& nlohmann_json_t) {
    ...
    if (nlohmann_json_j.contains("as_nested_tensors")) {
      nlohmann_json_t.variant_.emplace<28>(nlohmann_json_j.at("as_nested_tensors").template get<std::vector<std::vector<TensorArgument>>>());
      nlohmann_json_t.tag_ = Tag::AS_NESTED_TENSORS;
      return;
    }
    if (nlohmann_json_j.contains("as_int_lists")) {
      nlohmann_json_t.variant_.emplace<29>(nlohmann_json_j.at("as_int_lists").template get<std::vector<std::vector<int64_t>>>());
      nlohmann_json_t.tag_ = Tag::AS_INT_LISTS;
      return;
    }
    if (nlohmann_json_j.contains("as_string_to_argument")) {
      nlohmann_json_t.variant_.emplace<30>(nlohmann_json_j.at("as_string_to_argument").template get<std::unordered_map<std::string, ForwardRef<Argument>>>());
      nlohmann_json_t.tag_ = Tag::AS_STRING_TO_ARGUMENT;
      return;
    }
    if (nlohmann_json_j.contains("as_float_lists")) {
      nlohmann_json_t.variant_.emplace<31>(nlohmann_json_j.at("as_float_lists").template get<std::vector<std::vector<F64>>>());
      nlohmann_json_t.tag_ = Tag::AS_FLOAT_LISTS;
      return;
    }
  }
};
...
inline void parseEnum(std::string_view s, Argument::Tag& t) {
  ...
  if (s == "AS_NESTED_TENSORS") { t = Argument::Tag::AS_NESTED_TENSORS; return; }
  if (s == "AS_INT_LISTS") { t = Argument::Tag::AS_INT_LISTS; return; }
  if (s == "AS_STRING_TO_ARGUMENT") { t = Argument::Tag::AS_STRING_TO_ARGUMENT; return; }
  if (s == "AS_FLOAT_LISTS") { t = Argument::Tag::AS_FLOAT_LISTS; return; }
  throw std::runtime_error("Unknown enum value: " + std::string{s});
}
